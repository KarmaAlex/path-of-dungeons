...
public class Chestpiece extends Equippable{
    public Chestpiece(BaseItem item, HashMap<EntityStats, Integer> stats, Effects effect, Rarities rarity, Spells spell){
